...
<head>
  ...
  <meta name="description" content="Perpusta">
  ...
  <div class="container">
    ...
    <form class="form-signin" action="proseslogin.php" method="post">
      ...
      <button class="btn btn-lg btn-danger btn-block" type="button" onclick="location.href='tambah-anggota.php'">Sign Up</button>
    </form>
