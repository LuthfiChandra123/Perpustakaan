                            ...
                            <div class="panel-body">
                                <form class="form-horizontal style-form" style="margin-top: 20px;" action="insert-anggota.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="email" type="text" id="email" class="form-control" placeholder="Ex : xxx.@gmail.com" required />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input name="ttl" class="form-control" id="ttl" type="date" placeholder="Tempat, DD MM YY" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
