...
* [#11250](http://dev.ckeditor.com/ticket/11250): Fixed: php entities inside the `<textarea>` element are not encoded.
...
* [#10854](http://dev.ckeditor.com/ticket/10854): Fixed: Firefox prepends `<br>` to `<body>`, so it is stripped by the php data processor.
...
* [#9764](http://dev.ckeditor.com/ticket/9764): Widget System.
  ...
  * Default [`phpParser.filter`](http://docs.ckeditor.com/#!/api/CKEDITOR.phpParser.filter) rules are not applied to non-editable elements (elements with `contenteditable` attribute set to `false` and their descendants) anymore. To add a rule which will be applied to all elements you need to pass an additional argument to the [`filter.addRules`](http://docs.ckeditor.com/#!/api/CKEDITOR.phpParser.filter-method-addRules) method.
  * Dozens of new methods were introduced &ndash; most interesting ones:
      ...
      * New methods for [`phpParser.node`](http://docs.ckeditor.com/#!/api/CKEDITOR.phpParser.node) and [`phpParser.element`](http://docs.ckeditor.com/#!/api/CKEDITOR.phpParser.element).
...
* [#10389](http://dev.ckeditor.com/ticket/10389): Fixed: Invalid php in the "Text and Table" template.
...
* [#9995](http://dev.ckeditor.com/ticket/9995): php code in the `<textarea>` should not be modified by the [`phpDataProcessor`](http://docs.ckeditor.com/#!/api/CKEDITOR.phpDataProcessor).
...
* [#9713](http://dev.ckeditor.com/ticket/9713): Introduced the [Source Dialog](http://ckeditor.com/addon/sourcedialog) plugin that brings raw php editing for inline editor instances.
* Included in [#9829](http://dev.ckeditor.com/ticket/9829): Introduced new events, [`tophp`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-event-tophp) and [`toDataFormat`](http://docs.ckeditor.com/#!/api/CKEDITOR.editor-event-toDataFormat), allowing for better integration with data processing.
* [#9981](http://dev.ckeditor.com/ticket/9981): Added ability to filter [`phpParser.fragment`](http://docs.ckeditor.com/#!/api/CKEDITOR.phpParser.fragment), [`phpParser.element`](http://docs.ckeditor.com/#!/api/CKEDITOR.phpParser.element) etc. by many [`phpParser.filter`](http://docs.ckeditor.com/#!/api/CKEDITOR.phpParser.filter)s before writing structure to an php string.
...
* [#9796](http://dev.ckeditor.com/ticket/9796): Introduced `<s>` as a default tag for strikethrough, which replaces obsolete `<strike>` in php5.
